...
export function WaitlistSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="waitlist-form"
      className="relative w-full px-4 sm:px-6 lg:px-8 py-16 sm:py-20 z-20"
    >
      <motion.div
        style={{ scale, y, borderRadius }}
        className="max-w-5xl min-h-[500px] mx-auto px-4 sm:px-6 lg:px-14 py-16 rounded-3xl lg:rounded-[40px] bg-foreground text-background"
      >
            ...
            <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
              <div className="flex flex-col sm:flex-row gap-3 flex-wrap items-center justify-center">
                <input
                  ...
                  required
                  className="flex-1 px-4 py-3 rounded-3xl border border-muted-foreground bg-foreground text-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 disabled:opacity-50 disabled:cursor-not-allowed"
                />
                <input
                  ref={emailInputRef}
                  type="email"
