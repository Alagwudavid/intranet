    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth={1.5}>
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M11.5 22c-4.007 0-6.01 0-7.255-1.465C3 19.072 3 16.714 3 12s0-7.071 1.245-8.536S7.493 2 11.5 2s6.01 0 7.255 1.464c1.002 1.18 1.198 2.937 1.236 6.036M8 8h7m-7 5h3"
        ></path>
        <path d="M19.61 18.105A3.375 3.375 0 0 0 17.625 12h-.251a3.375 3.375 0 0 0-1.984 6.105m4.218 0a3.36 3.36 0 0 1-1.984.645h-.25a3.36 3.36 0 0 1-1.984-.645m4.218 0l.583 1.835c.222.7.334 1.05.303 1.268c-.063.454-.433.79-.87.792c-.21 0-.524-.164-1.153-.494c-.27-.142-.404-.212-.542-.254a1.5 1.5 0 0 0-.86 0c-.138.042-.273.112-.542.254c-.629.33-.943.495-1.153.494c-.437-.002-.807-.338-.87-.792c-.03-.218.08-.568.303-1.268l.583-1.835"></path>
      </g>
    </svg>
  );
};
...
const navigationItems = [
  ...
  // { icon: CourseIcon, label: 'Courses', href: '/courses' },
  // { icon: EventsIcon, label: 'Events', href: '/calendar' },
  // { icon: LearnIcon, label: 'Enrolled', href: '/me/enrolled' },
  // { icon: LibraryIcon, label: 'Library', href: '/me/library' },
  { icon: DashboardIcon, label: "Dashboard", href: "/me/dashboard" },
  { icon: null, label: "Profile", href: "/profile", isProfile: true },
];
...
const mobileNavItems = [
  { icon: HomeIcon, label: "Home", href: "/home" },
  { icon: DiscoverIcon, label: "Discover", href: "/discover" },
  // { icon: CommunitiesIcon, label: 'Communities', href: '/community' },
  { icon: null, label: "Profile", href: "/profile", isProfile: true },
];
...
const moreMenuItems = [
  { icon: DashboardIcon, label: "Dashboard", href: "/me/dashboard" },
  { icon: AppsIcon, label: "Apps & tools", href: "/#apps" },
  { icon: LibraryIcon, label: "Library", href: "/me/library" },
  { icon: AffiliateIcon, label: "Affiliate", href: "/me/archive" },
  { icon: Languages, label: "Language", href: "/#apps" },
];
...
const communities = [
  {
    ...
    image: "/assets/academy-1.png",
    color: "bg-indigo-500",
    notifications: 0,
  },
  {
    id: 2,
    name: "Microsoft & Excel Academy",
    image: "/assets/academy-2.png",
    color: "bg-gray-400",
    notifications: 0,
  },
  {
...
export default function Sidebar({ className = "" }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className={`flex min-h-page h-screen w-20 bg-muted flex-col items-center py-2 overflow-y-auto overflow-x-clip hide-scrollbar z-sidebar ${className}`}
      >
