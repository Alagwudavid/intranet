    ...
    return (
        <div className="max-w-3xl min-w-sm mx-auto p-4 shrink-0 space-y-4">
            ...
            <div className="space-y-4">
                {mockPosts.map((post) => (
                    <div key={post.id} className="border rounded-2xl shadow-sm">
                        <div className="flex items-center border-b rounded-t-2xl px-4 py-3 bg-muted/50">
                            <div className='flex items-center justify-between gap-4 text-sm w-full'>
                                ...
                                <button className="text-muted-foreground hover:text-foreground flex items-center gap-1 cursor-pointer">
                                    <Pin className="w-4 h-4 rotate-45" />
                                    <span className="text-xs hidden sm:inline">Pinned</span>
                                </button>
                            </div>
                        </div>
                        <div className="bg-background rounded-b-2xl p-4 overflow-hidden">
                            {/* Post Header */}
                            ...
                            <div className={`flex flex-col sm:gap-4`}>
                                <div className={`flex flex-col justify-between w-full`} >
                                    ...
                                    {/* Post Media */}
                                    {post.media && (
                                        <div className="relative w-full h-80 min-h-40 bg-muted rounded-lg overflow-hidden mx-auto">
                                            <Image
                                                src={post.media.url}
                                                alt="Post media"
                                                fill
                                                className="z-1 w-full h-full rounded-12 object-cover"
                                            />
                                ...
                                <div className="flex items-center gap-2">
                                    {post.reactions.map((reaction, idx) => (
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-medium text-muted-foreground hover:text-foreground transition-transform">{reaction.count}</span>
                                        </button>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="py-2 flex items-center justify-between">
                                <div className="flex items-center gap-6">
                                    <button className="flex items-center gap-2 transition-transform text-muted-foreground hover:text-primary rounded-lg hover:bg-background">
