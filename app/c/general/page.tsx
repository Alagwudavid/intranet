            ...
            <div className="space-y-4">
                {mockPosts.map((post) => (
                    <div key={post.id} className="border rounded-2xl shadow-sm">
                        <div className="flex items-center gap-2 text-sm border-b rounded-t-2xl px-4 py-3 bg-muted/50">
                        ...
                        <div className="bg-background rounded-b-2xl p-4 overflow-hidden">
                            ...
                            <div className="px-4 py-3 flex items-center justify-between">
                                <div className="flex items-center gap-6">
                                    ...
                                    <button className="flex items-center justify-center w-7 h-7 transition-transform text-muted-foreground hover:text-primary rounded-lg hover:bg-background">
